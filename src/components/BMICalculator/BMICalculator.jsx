...
import bmiImage from '../../assets/bmi.jpg'; // Corrected import path for image
...
const BMICalculator = () => {
  ...
  return (
    <section className="bmi" data-aos='fade-up' data-aos-duration='1500'>
      ...
      <div className="container">
        ...
        <div className="wrapper">
          <img src={bmiImage} alt="BMI" /> {/* Updated image source */}
        </div>
      </div>
      <ToastContainer />
    </section>
